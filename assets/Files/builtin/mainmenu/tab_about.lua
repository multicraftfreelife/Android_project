...
--------------------------------------------------------------------------------
local android_developers = {
	"Kulichkovskiy Sergey <multicraftfreelife@gmail.com>",
}
...
return {
	...
	cbf_formspec = function(tabview, name, tabdata)
		return "label[0.1,0;MultiCraft-Free Life Project, ver. 1.9]" ..
			"label[0.1,0.3;]" ..
			"label[0.1,0.5;https://multicraftfreelife.wixsite.com/guide]" ..
			...
			"#FFFF00," .. fgettext("Android Developers") .. ",," ..
			table.concat(android_developers, ",,") .. ",,," ..
